...
def convert_video(tf_sess, file_in, file_out):
    ...
    np.savetxt("latencies.csv", np.asarray(t_infer), delimiter=",")
...
graph_file_faster_rcnn = 'model/faster_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb'

input_file_video = 'data/Pedestrian_Detect_2_1_1.mp4'
...
def main():
    ...
    convert_image(session, input_file_image, "data/image-out.png")
    convert_video(session, input_file_video, "data/video-out-faster-rcnn.mp4")
